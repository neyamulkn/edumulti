    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <!-- ============================================================== -->
                <li class="nav-item">
                    <form action="{{route('admin.search')}}" method="get" class="app-search d-none d-md-block d-lg-block">
                        <input type="text" name="q" value="{{Request::get('q')}}" class="form-control" placeholder="Search & enter">
                    </form>
                </li>
            </ul>
            <!-- ============================================================== -->
            ...
            <ul class="navbar-nav my-lg-0">
               ...
               <!--  <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/images/users/'.Auth::guard('admin')->user()->photo)}}" alt="user" class=""> <span class="hidden-md-down">{{explode(' ', trim(Auth::guard('admin')->user()->name))[0]}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
