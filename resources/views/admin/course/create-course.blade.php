        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.course.store')}}" data-parsley-validate enctype="multipart/form-data" method="post" id="course">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-parsley-required-message = "course title is required" value="{{old('title')}}" name="title" required="" id="title" placeholder = 'Enter title' class="form-control" >
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required  onchange="get_subcategory(this.value)" name="category" id="category" class="select2 form-control custom-select">
                                                   ...
                                                   <option @if(Session::get("category_id") == $category->id || old('category') == $category->id) selected @endif  value="{{$category->id}}">{{$category->name}}</option>
                                                   @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input data-parsley-required-message = "Selling price is required" required type="text" value="{{old('price')}}"  name="price" id="price" placeholder = 'Enter selling price' class="form-control" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                    	...
                                    	<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" required class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpg jpeg png gif"  data-max-file-size="10M"  name="thumbnail_image" id="input-file-events">
                                                <i class="info">Image Size: 365px*250px</i>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div id="video_provider_field"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="start_date">Start date</label>
                                                <input type="date" value="{{old('start_date')}}" placeholder = 'Enter start date' name="start_date" id="start_date" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="end_date">End date</label>
                                                <input type="date" value="{{old('end_date')}}" placeholder = 'Enter expired date' name="end_date" id="end_date" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                        ...
                        <div class="form-actions pull-right" style="float: right;">
                            <button type="submit"  name="submit" value="save" class="btn btn-success"> <i class="fa fa-save"></i> Save course </button>
