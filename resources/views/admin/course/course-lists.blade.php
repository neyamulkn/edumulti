                                        ...
                                        <tbody>
                                            @if(count($courses)>0)
                                                ...
                                                <tr id="item{{$course->id}}">
                                                    ...
                                                    <td>{{count($course->course_enroll)}}</td>
                                                    <td>0</td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a title="add course lessons" class="dropdown-item"  href="{{route('admin.course.lessons', $course->slug)}}"><i class="ti-pin-alt"></i> Sections & Lessons</a>
