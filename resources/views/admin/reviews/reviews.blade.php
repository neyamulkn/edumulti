                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="positionSorting">
                                        ...
                                        <tr id="item{{$review->id}}">
                                            ...
                                            <td><a target="_blank" href="{{ route('course_details', $review->slug) }}"><img src="{{asset('upload/images/course/thumb/'. $review->feature_image)}}" width="50"> {{Str::limit($review->course_name, 30)}}</a></td>
                                            <td><a href="{{ route('student.profile', $review->username) }}"> {{$review->student_name}}</a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-row">
                    <div class="card-body">
                        <form action="{{route('courseReviewInsert')}}" enctype="multipart/form-data" method="POST" class="floating-labels">
                            {{csrf_field()}}
                            <div class="form-body">
                                <!--/row-->
