                ...
                <form method="POST" data-parsley-validate action="{{ route('password.recoverUpdate') }}">
                    ...
                    <fieldset class=" form__change-password">
                        <legend class="form__legend">
                         <h3 style="text-align: center;">Recover Password</h3></legend>
                        ...
                        <div class="form__field__wrapper form-item">
                          <label for="edit-old-pass" class="text-input__label--floated">{{ __('New Password') }}<span class="form-required" aria-hidden="true" title="This field is required."></label>
                          <input class="form-control form-text password__field text-input__field--floated required" placeholder="Enter new password" type="password" id="edit-old-pass" name="password" size="60" minlength="6" aria-required="true">
                        ...
                        <div class="form__field__wrapper form-item">
                          <label for="edit-new-pass" class="text-input__label--floated">{{ __('Confirm Password') }}<span class="form-required" aria-hidden="true" title="This field is required."></label>
