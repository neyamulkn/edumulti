                            ...
                            <div class="row">
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img8.jpg" alt=""></a>
                                ...
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img9.jpg" alt=""></a>
                                        </div><!-- end card-image -->
                                        <div class="card-content">
                                            <p class="card__label">
                                                <span class="card__label-text">beginner</span>
                                ...
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_3">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img10.jpg" alt=""></a>
                                            <div class="card-badge">
                                ...
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_4">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img11.jpg" alt=""></a>
                                        </div><!-- end card-image -->
                                        <div class="card-content">
                                            <p class="card__label">
                                ...
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_5">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img12.jpg" alt=""></a>
                                            <div class="card-badge">
                                                <span class="badge-label">bestseller</span>
                                            </div>
                                        </div><!-- end card-image -->
                                ...
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_6">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img src="{{ asset('frontend') }}/images/img13.jpg" alt=""></a>
                                        </div><!-- end card-image -->
                                        <div class="card-content">
                                            <p class="card__label">
                                                <span class="card__label-text">all levels</span>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab5">
                            <div class="row">
                                <div class="col-lg-4 column-td-half">
                                    <div class="card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                        <div class="card-image">
                                            <a href="course-details.html" class="card__img"><img
                                                    src="{{ asset('frontend') }}/images/img13.jpg" alt=""></a>
                                            <div class="card-badge">
                                                <span class="badge-label">bestseller</span>
                                            </div>
                                        </div><!-- end card-image -->
    ...
    <div class="container">
        ...
        <div class="row margin-top-28px">
            <div class="col-lg-4 column-td-half">
                <div class="team-item">
                    <div class="team-img-box">
                        <img src="{{ asset('frontend') }}/images/team.jpg" alt="">
            ...
            <div class="col-lg-4 column-td-half">
                <div class="team-item">
                    <div class="team-img-box">
                        <img src="{{ asset('frontend') }}/images/team5.jpg" alt="">
                        <ul class="social-profile">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
            ...
            <div class="col-lg-4 column-td-half">
                <div class="team-item">
                    <div class="team-img-box">
                        <img src="{{ asset('frontend') }}/images/team6.jpg" alt="">
                        <ul class="social-profile">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                ...
                <div class="testimonial-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img.jpg" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img2.jpg" alt="small-avatar">
                           <div class="testimonial__name">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img3.jpg" alt="small-avatar">
                            <div class="testimonial__name">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img4.jpg" alt="small-avatar">
                            <div class="testimonial__name">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img5.jpg" alt="small-avatar">
                            <div class="testimonial__name">
                                <h3 class="testimonial__name-title">Kevin Martin</h3>
                                <span class="testimonial__name-meta">student</span>
                                <ul class="review-stars d-inline-block">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-header">
                            <img src="{{ asset('frontend') }}/images/testi-img6.jpg" alt="small-avatar">
                            <div class="testimonial__name">
                                <h3 class="testimonial__name-title">Jessica Brown</h3>
                                <span class="testimonial__name-meta">student</span>
                                <ul class="review-stars d-inline-block">
...
<section class="benefit-area padding-bottom-180px overflow-hidden">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="img-box">
                    <img src="{{ asset('frontend') }}/images/img13.jpg" alt="">
                    <img src="{{ asset('frontend') }}/images/img14.jpg" alt="">
                </div>
            </div>
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="col-lg-12">
                <div class="client-logo margin-top-30px">
                    <div class="client-logo-item">
                        <a href="#"><img src="{{ asset('frontend') }}/images/sponsor-img.png" alt="brand image"></a>
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <a href="#"><img src="{{ asset('frontend') }}/images/sponsor-img2.png" alt="brand image"></a>
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <a href="#"><img src="{{ asset('frontend') }}/images/sponsor-img3.png" alt="brand image"></a>
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <a href="#"><img src="{{ asset('frontend') }}/images/sponsor-img4.png" alt="brand image"></a>
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <a href="#"><img src="{{ asset('frontend') }}/images/sponsor-img5.png" alt="brand image"></a>
                    </div><!-- end client-logo-item -->
                </div><!-- end client-logo -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
            ...
            <div class="col-lg-12">
                <div class="blog-post-carousel owl-dot-and-nav">
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img9.jpg" alt=""></a>
                            <div class="card-badge">
                    ...
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img10.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
                    ...
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img11.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
                    ...
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img12.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
                    ...
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img13.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
                    ...
                    <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img14.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
                    ...
                    <div class="card-item blog-card">
                     ...
                     <div class="card-item blog-card">
                        <div class="card-image">
                            <a href="blog-single.html" class="card__img"><img src="{{ asset('frontend') }}/images/img8.jpg" alt=""></a>
                            <div class="card-badge">
                                <span class="badge-label">24 Jan</span>
                            </div>
                        </div><!-- end card-image -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 column-td-half">
                <div class="post-card">
                    <div class="post-card-content">
                        <img src="{{ asset('frontend') }}/images/img33.jpg" alt="" class="img-fluid">
            ...
            <div class="col-lg-4 column-td-half">
                <div class="post-card">
                    <div class="post-card-content">
                        <img src="{{ asset('frontend') }}/images/img34.jpg" alt="" class="img-fluid">
            ...
            <div class="col-lg-4 column-td-half">
                <div class="post-card">
                    <div class="post-card-content">
                        <img src="{{ asset('frontend') }}/images/img35.jpg" alt="" class="img-fluid">
