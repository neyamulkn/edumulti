				...
				<div class="col-lg-8 col-md-12 col-sm-12 col-12">
					<div class="article_detail_wrapss single_article_wrap format-standard">
						<div class="article_body_wrap">
							...
							<div class="article_featured_image">
								<img class="img-fluid" src="{{ asset('frontend') }}/img/h-5.png" alt="">
							</div>
					...
					<div class="article_detail_wrapss single_article_wrap format-standard">
						...
						<div class="article_posts_thumb">
							<span class="img"><img class="img-fluid" src="{{ asset('frontend') }}/img/user-1.jpg" alt=""></span>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-12">
					...
					<div class="single_widgets widget_thumb_post">
						...
						<ul>
							<li>
								<span class="left">
									<img src="{{ asset('frontend') }}/img/tour-1.html" alt="" class="">
								</span>
								<span class="right">
							...
							<li>
								<span class="left">
									<img src="{{ asset('frontend') }}/img/tour-2.html" alt="" class="">
								</span>
								<span class="right">
							...
							<li>
								<span class="left">
									<img src="{{ asset('frontend') }}/img/tour-3.html" alt="" class="">
								</span>
								<span class="right">
							...
							<li>
								<span class="left">
									<img src="{{ asset('frontend') }}/img/tour-4.html" alt="" class="">
								</span>
								<span class="right">
							...
							<li>
								<span class="left">
									<img src="{{ asset('frontend') }}/img/tour-5.html" alt="" class="">
								</span>
								<span class="right">
